...
In order to support loading of multiple wallets in mag-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mag.cpp.
...
Changes to mag.cpp
----------------------
mag.cpp is the entry point into mag-qt, and as such, will require some minor modifications to provide hooks for
