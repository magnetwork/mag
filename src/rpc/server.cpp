...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"zerocoin", "getzmagseed", &getzmagseed, false, false, true},
        {"zerocoin", "setzmagseed", &setzmagseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmag", &searchdzmag, false, false, true},
        {"zerocoin", "dzmagstate", &dzmagstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17103/\n";
}
