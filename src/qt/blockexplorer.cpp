...
{
    std::string genesisblockhash = "00000d4ca0b20413a832a5011755f1adb74a37071e4f2ce6872b6eca5e9b05b0";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (mag.conf).");
